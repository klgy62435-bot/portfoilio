      ...
      <section id="home" className="relative z-10 min-h-screen flex items-center justify-center px-6 pt-20">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="relative mb-8 inline-block">
            ...
            <div className={`relative w-48 h-48 mx-auto rounded-full border-4 ${
              ...
              <img
                ...
                onError={(e) => {
                  ...
                  const fallbacks = ['/IMG.jpg', '/IMG.jpeg', '/profile.jpg', '/profile.png', '/profile.jpeg'];
                  const currentSrc = e.target.src;
                  const currentIndex = fallbacks.findIndex(path => currentSrc.includes(path.replace('/', '')));

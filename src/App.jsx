...
// Use your personal photo
const profileImageUrl = import.meta.env.BASE_URL + "IMG_3718.jpg"; // صورة JPG
...
const App = () => {
  ...
  useEffect(() => {
    console.log('🔍 PORTFOLIO - Profile image init');
    console.log('🖼️ Profile image (JPG):', profileImageUrl);
  }, []);
  ...
  return (
    <div className={`${themeClasses} font-sans min-h-screen relative overflow-x-hidden`}>
        ...
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex justify-between items-center">
              ...
              {['home', 'projects', 'services', 'contact'].map((item) => (
                <a
                  ...
                  className={`relative transition-colors duration-300 ${
                    activeSection === item
                      ? (isDark ? 'text-cyan-400' : 'text-blue-600')
                      : (isDark ? 'text-gray-300 hover:text-cyan-400' : 'text-gray-600 hover:text-blue-600')
                  }`}
            ...
            <div className="flex items-center space-x-4">
              ...
              >
                <div className={`w-5 h-5 rounded-full transition-all duration-300 flex items-center justify-center text-xs font-bold ${
                  isDark ? 'bg-cyan-400 text-gray-900' : 'bg-blue-600 text-white'
              ...
              >
                <div className={`w-5 h-5 rounded-full transition-all duration-300 flex items-center justify-center text-xs ${
                  isDark ? 'bg-gray-900 translate-x-0.5' : 'bg-white translate-x-6'
                }`}>
                  {isDark ? '🌙' : '☀️'}
                </div>
              </button>
      ...
      <section id="home" className="relative z-10 min-h-screen flex items-center justify-center px-6 pt-20">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="relative mb-8 inline-block">
            ...
            {/* Profile Image - Your Real Photo */}
            <div style={{
              width: '200px',
              height: '200px',
              margin: '0 auto',
              borderRadius: '50%',
              border: isDark ? '4px solid #22d3ee' : '4px solid #2563eb',
            ...
            >
              <img
                src={profileImageUrl}
                alt="Ahmed Design - Profile Photo"
                style={{
                  width: '100%',
                  height: '100%',
                  objectFit: 'cover',
                  objectPosition: 'center 20%', // lowered more to show full head
                  borderRadius: '50%'
                }}
                onLoad={(e) => {
                  console.log('✅ Profile photo loaded');
                  console.log('📸 Image source:', e.target.currentSrc || e.target.src);
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className={`group relative overflow-hidden rounded-2xl ${
              ...
              <div className={`absolute inset-0 ${
                isDark ? 'bg-gradient-to-br from-cyan-400/10 to-blue-600/10' : 'bg-gradient-to-br from-blue-600/10 to-purple-600/10'
              ...
              <div className="relative z-10">
                ...
                <h4 className="text-2xl font-bold mb-4">{t('projects.logoDesign')}</h4>
            ...
            <div className={`group relative overflow-hidden rounded-2xl ${
              ...
              <div className={`absolute inset-0 ${
                isDark ? 'bg-gradient-to-br from-purple-400/10 to-pink-600/10' : 'bg-gradient-to-br from-purple-600/10 to-pink-600/10'
              } opacity-0 group-hover:opacity-100 transition-opacity duration-500`}></div>
              ...
              <div className="relative z-10">
                ...
                <h4 className="text-2xl font-bold mb-4">{t('projects.videoEditing')}</h4>
                <p className={`${isDark ? 'text-gray-300' : 'text-gray-600'} mb-6 leading-relaxed`}>
            ...
            <div className={`group relative overflow-hidden rounded-2xl ${
              ...
              <div className={`absolute inset-0 ${
                isDark ? 'bg-gradient-to-br from-green-400/10 to-emerald-600/10' : 'bg-gradient-to-br from-green-600/10 to-emerald-600/10'
              } opacity-0 group-hover:opacity-100 transition-opacity duration-500`}></div>
              ...
              <div className="relative z-10">
                ...
                <h4 className="text-2xl font-bold mb-4">{t('projects.mobileApps')}</h4>
                <p className={`${isDark ? 'text-gray-300' : 'text-gray-600'} mb-6 leading-relaxed`}>
      ...
      <section id="services" className="relative z-10 py-20 px-6">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {/* Logo Design Service */}
            <div className={`group text-center p-8 rounded-2xl ${
              ...
              <div className={`w-20 h-20 mx-auto rounded-full ${
                isDark ? 'bg-gradient-to-br from-cyan-400 to-blue-500' : 'bg-gradient-to-br from-blue-500 to-purple-600'
              } flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300 shadow-lg`}>
                <span className="text-4xl">🎨</span>
              </div>
              <h4 className="text-2xl font-bold mb-4">{t('services.logoDesign')}</h4>
            ...
            <div className={`group text-center p-8 rounded-2xl ${
              ...
              <div className={`w-20 h-20 mx-auto rounded-full ${
                isDark ? 'bg-gradient-to-br from-purple-400 to-pink-500' : 'bg-gradient-to-br from-purple-500 to-pink-600'
              } flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300 shadow-lg`}>
                <span className="text-4xl">🎬</span>
              </div>
              <h4 className="text-2xl font-bold mb-4">{t('services.videoEditing')}</h4>
              <p className={`${isDark ? 'text-gray-300' : 'text-gray-600'} leading-relaxed`}>
            ...
            <div className={`group text-center p-8 rounded-2xl ${
              ...
              <h4 className="text-2xl font-bold mb-4">{t('services.mobileApps')}</h4>
              <p className={`${isDark ? 'text-gray-300' : 'text-gray-600'} leading-relaxed`}>
      ...
      <footer className={`relative z-10 text-center py-8 border-t ${
        ...
        <p className={`${isDark ? 'text-gray-400' : 'text-gray-600'} mb-4`}>
          &copy; 2025 {t('hero.name')}. {isArabic ? 'جميع الحقوق محفوظة' : 'All Rights Reserved'}.
        </p>
